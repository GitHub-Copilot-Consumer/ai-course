# Spec: ch4-coding-agent

## Purpose

Define the requirements for Ch4, renamed from "ch4-opencode" to "ch4-coding-agent", focusing on structured Brownfield development with Coding Agents using Plan Mode and task-based implementation.
