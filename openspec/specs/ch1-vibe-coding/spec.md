# Spec: ch1-vibe-coding

## Purpose

Define the requirements for Ch1, repositioned as "Vibe Coding 與快速原型" — covering Vibe Coding methodology, prototype exit conditions, Copilot tooling, and an MVP-building lab in the Greenfield phase.
