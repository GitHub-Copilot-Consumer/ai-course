...
Define the requirements for the course appendix covering tool installation and environment setup for all required tools (OpenSpec CLI, OpenCode, API Keys, Ollama).
