# Spec: course-narrative-greenfield-brownfield

## Purpose

Define the requirements for establishing the overarching Greenfield → Brownfield two-phase narrative across the course index, Ch0, and the intro chapter, anchoring the entire course structure around the MVP as the transition point.
