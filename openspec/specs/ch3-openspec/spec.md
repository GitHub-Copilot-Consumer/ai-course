...
Define the requirements for Ch3 (OpenSpec), repositioned to focus on converting a Proposal into executable Technical Specs and providing a preview of the apply/verify/archive workflow that is detailed in Ch4 and Ch5.
